...
public class JunkfoodFragment extends Fragment {
    private ListView junkfood_listview;
    private GoodsAdapter goodsAdapter;
    private List<GoodsBean> list;
    private GetServerData getServerData;
    private GetHandler handler=new GetHandler();
    private View view;
    private String sort="辣条";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedIntanceState) {
        view = inflater.inflate(R.layout.junkfood_fragment, container, false);
        get();
        return view;
    }
    class GetHandler extends Handler {
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case 0:
                    junkfood_listview=(ListView)view.findViewById(R.id.junkfood_listview);
                    list=(List<GoodsBean>)msg.obj;
                    goodsAdapter=new GoodsAdapter(list,getActivity());
                    junkfood_listview.setAdapter(goodsAdapter);
                    break;
                default:
                    break;
            }
