...
public class BiscuitsFragment extends Fragment {
    private ListView biscuits_listview;
    private GoodsAdapter goodsAdapter;
    private List<GoodsBean> list;
    private GetServerData getServerData;
    private GetHandler handler=new GetHandler();
    private View view;
    private String sort="饼干";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedIntanceState) {
        view = inflater.inflate(R.layout.bissuits_fragment, container, false);
        get();
        return view;
    }
    class GetHandler extends Handler {
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case 0:
                    biscuits_listview=(ListView)view.findViewById(R.id.biscuits_listview);
                    list=(List<GoodsBean>)msg.obj;
                    goodsAdapter=new GoodsAdapter(list,getActivity());
                    biscuits_listview.setAdapter(goodsAdapter);
                    break;
                default:
                    break;
            }
